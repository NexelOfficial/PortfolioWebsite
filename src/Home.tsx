        ...
        <header style={{ height: "100%" }}>
            <section id="home-gradient">
                ...
                <button
                    ...
                    onClick={() => {
                        setThemesShown(!themesShown);
                        console.log(themesShown);
                    }}>
                    <i className="fas fa-palette"></i>
                </button>

                {themesShown ? <ThemeButtons /> : <></>}
            ...
            <section className="text-section bg-svg padding" id="about-me">
                <div className="fade-in liquid-div flex">
                    <div>
                        <h2>Projects</h2>
                        <p>
                            I've created and worked on numerous projects in
                            the past. These projects vary in size and skill,
                            some were created in my earlier stages of
                            programming and some in my later stages. Click
                            here if you would like to read more or view my
                            projects.
                        </p>
                    </div>
                    <img
